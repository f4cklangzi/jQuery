...
/**
 *===================================================
 *Filename:show_distill.php
 *Author:f4ck_langzi@foxmail.com
 *Date:2016-06-28 22:38
 *===================================================
 **/
require_once 'config.php';
$_sql="SELECT (SELECT COUNT(*) FROM comment WHERE question_id=question.id)AS count,(length(content))AS length,id,title,content,username,date FROM question ORDER BY length DESC LIMIT 1";
$_response='';
