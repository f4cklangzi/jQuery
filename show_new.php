...
/**
 *===================================================
 *Filename:show_new.php
 *Author:f4ck_langzi@foxmail.com
 *Date:2016-06-28 22:36
 *===================================================
 **/
require_once 'config.php';
$_sql="SELECT (SELECT COUNT(*) FROM comment WHERE question_id=question.id)AS count,id,title,content,username,date FROM question ORDER BY date DESC LIMIT 1";
$_response='';
